...
const fallback: I18nObject = {
  ...
  reward: {
    ...
    backers: 'Backers',
    new: 'New Reward',
    backer_limit: 'Backer Limit',
    image: 'Reward Image',
    image_text: 'Select an image that represents this reward item.',
  },
  profile: {
    title: 'Profile',
    settings: 'Settings',
  ...
  create: {
    ...
    text: "This is where your vision takes shape! Whether you're launching a product, funding a cause, or building a community, this is where it all begins.",
    start: 'Start Date',
  },
  edit_project: {
    title: 'Edit Project',
    text: 'Add image, rewards, and update info until your project is ready to submit!',
    no: 'Project not found',
    images:
      'Upload and arrange images. The first image is used when your project shows in a list.',
    rewards:
      'Add, update, and remove rewards. At least one reward is necessary before submitting.',
  ...
  errors: {
    asset_verify: 'Failed to upload or verify file.',
    ...
    FILE_SIZE_BIG: 'Maximum image size is 20 MB',
    FILE_TYPE: 'Unsupported file type',
    InvalidFormData: 'Invalid input',
    Unknown: 'Unknown error, check info or try again layer.',
    None: 'Unknown error',
  },
}
